...
class teacher(human):
    ...
    def perviousIllnessHistory(self,flag):
        if flag == True:
            return "Pervious Illness History"
        else:
            return "Not Pervious Illness History"
    def workExperience(self,wE):
        if wE <= 10 and wE>= 0:
            return "Junior teacher"
        elif wE < 30 and wE >= 11:
            return "Sinior teacher"
        elif wE == 30:
...
h1 = human(n,f,b)
print(h1.whoAmI())
print(h1.areYouOldEnough(h1.age()))
...
print(t1.name)
print(t1.perviousIllnessHistory(True))
print(t1.workExperience(15))
print(t1.workExperience(35))
print(t1.workExperience(5))