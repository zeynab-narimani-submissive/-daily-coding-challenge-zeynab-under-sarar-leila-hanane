class school:
    ...
    def ave10to12(self):
        ...
        return lstName1
    def reversetplname(self):
        lstReverseName = []
        for i in range(len(self.tplStudentName)-1,-1,-1):
            lstReverseName.append(self.tplStudentName[i])
        return lstReverseName
    def startWith(self,letter):
        for i in self.tplStudentName:
            if i[0] == letter:
                print("Names that start with the letter " + letter +": ",i)
    def endWith(self,letter):
        for i in self.tplStudentName:
            if i[-1] == letter:
                print("Names that End with the letter " + letter +": ",i)
tplNames = ("Zhara Razavi","Mahsa Sadat","Nasrin Miralami","Zohre Najafi")
tplClass = (2,3,2,1)
